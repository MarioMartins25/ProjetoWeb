        ...
        <div id="wrapper">
            ...
            <div class="content-page">
              ...
              <div class="content">
                <div class="container">
                  <!-- ####################### CONTENT ###################### -->
                  <form class="form-horizontal" action="router.php?route=dashboard&action=novaDica" method="post" role="form">
                        <div class="col-sm-12">
                        	<div class="card-box">
                        		<div class="col-md-8">
                                    <h4 class="m-t-0 header-title"><b>Adicionar Dicas</b></h4>
                            		<p class="text-muted m-b-30 font-13">
                            			Adicionar uma nova dica.
                            		</p>
                                </div>
                        		<div class="row">
                        			<div class="col-md-12">
                                  <div class="form-group">
                                      <label class="col-md-1 control-label" for="dica">Dica</label>
                                      <div class="col-md-11">
                                        <input type="text" class="form-control" name="dica" value="" placeholder="Dica">
                                      </div>
                                  </div>
...
$(document).ready(function(){
    sweetAlert(
      'Dica adicionada',
      'Inseriu uma nova dica com sucesso!',
      'success'
    )
});
</script>
...
case 1:
$msg = "'O campo da dica não pode estar vazio',
'O campo da dica, deve estar devidamente preenchido, tente de novo por favor!',
'error'";
break;
case 2:
$msg = "'A dica já existe',
'A dica que tentou inserir já existe na base de dados, utilize outra por favor!',
'error'";
break;
default:
